...
class Dialog(QDialog):
	...
	def clickedAdvanced(self,state):
		if self.advancedEnable.isChecked():
			...
			if config.PRINT_SCRIPT_ERRORS_TO_STDOUT:
				...
				self.errorConsole.setChecked(False)
	...
	def __init__(self,app=None,parent=None):
		...
		ssLayout.addWidget(self.displayServNicks)
		...
		stLayout.addWidget(self.systrayMinOnClose)
		stLayout.addWidget(self.doubleclickRestore)
		...
		pmLayout.addWidget(self.createWindowOut)
		...
		self.plugMotd = QCheckBox("motd",self)
		...
		self.errorConsole = QCheckBox("Write all script errors to STDOUT",self)
		if config.PRINT_SCRIPT_ERRORS_TO_STDOUT: self.errorConsole.setChecked(True)
