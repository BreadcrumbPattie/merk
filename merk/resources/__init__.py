...
APPLICATION_WEB = "https://merk.chat"
APPLICATION_DEVELOPMENT = "https://latest.merk.chat"
...
DEFAULT_PLUGIN_README = f"""%_NAME_% %_VERSION_%
By %_AUTHOR_%
%_URL_%
...
def resource_path(relative_path):
	...
	return os.path.join(install, relative_path)
